...
if fin_data:
    ...
    rev_df = pd.DataFrame.from_dict(rev_data, orient="index", columns=[t("operating_revenue")])
    ...
    rd_df = pd.DataFrame.from_dict(rd_data, orient="index", columns=[t("rd_investment")])
